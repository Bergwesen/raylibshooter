...
PROJECTS := raylibshooter raylib

.PHONY: all clean help $(PROJECTS) 

all: $(PROJECTS)

raylibshooter: raylib
ifneq (,$(raylibshooter_config))
	@echo "==== Building raylibshooter ($(raylibshooter_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f raylibshooter.make config=$(raylibshooter_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f raylibshooter.make clean
